...
import com.example.toben.printtest.common.MessageCenter;
import com.example.toben.printtest.common.MessageType;

/**
 * Created by toben on 17/09/2018.
 */

public class BaseActivityN extends Activity {
    ...
    private ServiceConnection mServiceConn = new ServiceConnection() {
        ...
        public void onServiceDisconnected(ComponentName name) {
            ...
            mIzkcService = null;
            Toast.makeText(BaseActivityN.this, getString(R.string.service_bind_fail), Toast.LENGTH_SHORT).show();
        ...
        public void onServiceConnected(ComponentName name, IBinder service) {
            ...
            if(mIzkcService!=null){
                try {
                    Toast.makeText(BaseActivityN.this, getString(R.string.service_bind_success), Toast.LENGTH_SHORT).show();
